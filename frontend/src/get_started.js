          ...
          <div className="relative z-10 flex flex-col h-full p-6">
            ...
            <div className="flex-shrink-0 pb-8">
              <span className="text-white text-2xl mb-2">
                Elevate Your Strength, Redefine Your Limits.
              </span>
              <p className="text-xs font-thin text-white mb-6 ">
                Track your progress and build elite strength with workouts made
                just for you.
              </p>
