...
function Login() {
    ...
    return (
        <div>
            <div className="relative flex h-auto min-h-screen w-full flex-col items-center bg-bg-dark dark group/design-root overflow-x-hidden">
                <div className="flex w-full max-w-md flex-col px-4 pt-16">
                    {/* Headline */}
                    <h1 className="text-white tracking-light text-[32px] font-bold leading-tight px-4 text-left pb-6 pt-6">
                    Welcome Back
                    </h1>
                    {/* Email Text Field */}
                    ...
                    <label className="flex flex-col min-w-40 flex-1">
                        ...
                        <input
                            className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border-none bg-[#393028] h-14 placeholder:text-[#baab9c] p-4 text-base font-normal leading-normal"
                    ...
                    <label className="flex flex-col min-w-40 flex-1">
                        ...
                        <div className="flex w-full flex-1 items-stretch rounded-lg bg-[#393028] focus-within:ring-2 focus-within:ring-primary/50">
                        <input
                            className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-l-lg text-white focus:outline-0 focus:ring-0 border-none bg-transparent h-14 placeholder:text-[#baab9c] p-4 text-base font-normal leading-normal"
                        ...
                        />
                        <div className="text-[#baab9c] flex items-center justify-center pr-4">
                    ...
                    <button onClick={() => handleLoginClick()} className="flex min-w-[84px] w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 flex-1 bg-primary text-background-dark text-base font-bold leading-normal tracking-[0.015em]">
                    ...
                    <p className="text-[#baab9c] text-sm font-normal">or continue with</p>
                    <div className="h-px flex-1 bg-[#393028]" />
                    </div>
                    ...
                    <p className="text-[#baab9c] text-base font-normal">
                        Don't have an account?{" "}
                        <a onClick={handleSignUpClick} className="font-bold text-primary underline">
                        Sign Up
                        </a>
                    </p>
                    </div>
